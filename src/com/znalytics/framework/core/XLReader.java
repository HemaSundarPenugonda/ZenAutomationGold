...
public class XLReader {
	...
	@DataProvider(name = "ExcelDataLoaderEnrollment")
	public static Object[][] getTestDataEnrollment(Constructor<?> c) {
		if (c.getName().contains("EnrollmentApiTests")) {
			System.out.println("Constants.DATAFILE= "+Constants.DATAFILE);
			List<String> getAllSheets = XLReader
					.getWorkSheets(Constants.DATAFILE);
			Constants.DATASHEET = Utils.getListIndexValueIgnoreCase(getAllSheets, "Scenario");
			System.out.println("Constants.DATASHEET= "+Constants.DATASHEET);
			System.out.println("---------------------------------------");
		}
	...
	@DataProvider(name = "ExcelDataLoaderProductManagement")
	public static Object[][] getTestDataProductManagement(Constructor<?> c) {
		if (c.getName().contains("CreateProduct")) {
			List<String> getAllSheetName = XLReader
					.getWorkSheets(Constants.DATAFILE);
			Constants.DATASHEET = Utils.getListIndexValueIgnoreCase(
					getAllSheetName, "addproduct");
		} else if (c.getName().contains("ModifyProduct")) {
			List<String> getAllSheetName = XLReader
					.getWorkSheets(Constants.DATAFILE);
			Constants.DATASHEET = Utils.getListIndexValueIgnoreCase(
					getAllSheetName, "modifyproduct");
		} else if (c.getName().contains("ApiTests")) {
			List<String> getAllSheetName = XLReader
					.getWorkSheets(Constants.DATAFILE);
			Constants.DATASHEET = Utils.getListIndexValueIgnoreCase(
					getAllSheetName, "API");
	...
	public static List<String> getWorkSheets(String fileName) {
		...
		try {
			...
			System.out.println("List of sheets : " + list);
		} catch (Exception e) {
